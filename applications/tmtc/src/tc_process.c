...
void TcProcessMain(void)
{
    ...
    static pusExecutionTable_t normal_exec_tab[NB_NORMAL_EXECUTION] = {
        ...
        { BUILD_ROUTING_KEY(OBC_APID, 160u, 1u),   ExecuteS160SS1,  TM_NOT_REQUESTED, NULL },
        { BUILD_ROUTING_KEY(OBC_APID, 160u, 2u),   ExecuteS160SS2,  TM_NOT_REQUESTED, NULL },
        { BUILD_ROUTING_KEY(OBC_APID, 160u, 17u),  ExecuteS160SS17, TM_REQUESTED,     NULL },
        { BUILD_ROUTING_KEY(OBC_APID, 160u, 19u),  ExecuteS160SS19, TM_REQUESTED,     NULL },
        { BUILD_ROUTING_KEY(OBC_APID, 160u, 21u),  ExecuteS160SS21, TM_REQUESTED,     NULL },
        { BUILD_ROUTING_KEY(OBC_APID, 160u, 23u),  ExecuteS160SS23, TM_NOT_REQUESTED, NULL },
        { BUILD_ROUTING_KEY(OBC_APID, 160u, 33u),  ExecuteS160SS33, TM_REQUESTED,     NULL },
        { BUILD_ROUTING_KEY(OBC_APID, 160u, 35u),  ExecuteS160SS35, TM_REQUESTED,     NULL },
        { BUILD_ROUTING_KEY(OBC_APID, 160u, 37u),  ExecuteS160SS37, TM_REQUESTED,     NULL },
    };
