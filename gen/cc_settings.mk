...
PROJECT_DEFINES += -D$(shell echo CONSOLE_MODE_$(CONSOLE_MODE) | tr 'a-z-' 'A-Z_') # Define how we use the console (none, uart, file, circular-buffer)
PROJECT_DEFINES += -D$(shell echo FS_MODE_$(FS_MODE) | tr 'a-z-' 'A-Z_') # Define with which peripheral we use the file system (none, spi)
