...
APPLICATION_INCFLAGS += -I$(LIBFS_INCDIR)
...
APPLICATION_OBJS = $(patsubst $(APPLICATION_SRCDIR)/%.c,$(BUILD_APPLICATION_DIR)/%-$(VERSION).o,$(patsubst $(PRE_BUILD_DIR)/conf/%.c,$(BUILD_APPLICATION_DIR)/conf/%-$(VERSION).o,$(APPLICATION_SRCS)))
...
$(BUILD_APPLICATION_DIR)/conf/%-$(VERSION).o  : $(PRE_BUILD_DIR)/conf/%.c
	mkdir -p $(@D)
	$(CC) $(APPLICATION_CFLAGS) $(APPLICATION_INCFLAGS) $(VERSION_FLAGS) $^ -o $@
