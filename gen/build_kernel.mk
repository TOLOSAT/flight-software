...
# Kernel files
KERNEL_SRCS = $(wildcard $(KERNEL_SRCDIR)/*.c $(KERNEL_SRCDIR)/*/*.c $(KERNEL_DRV_SRCDIR)/*.c $(KERNEL_DRV_SRCDIR)/peripherals/*.c $(KERNEL_DRV_SRCDIR)/others/*.c $(DISKDRV) $(MEMDRV)) $(SYS_CONF_SRCS) $(BSP_CONF_SRCS)
