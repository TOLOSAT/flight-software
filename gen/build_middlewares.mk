...
IRIDIUM_DRV_OBJS = $(subst $(IRIDIUM_DRV_SRCDIR)/,$(IRIDIUM_DRV_OBJDIR)/,$(IRIDIUM_DRV_SRCS:.c=-$(VERSION).o))
IRIDIUM_DRV_LIB  = $(BUILD_LIBS_DIR)/libiridiumdrv-$(VERSION).a

# IRIDIUM_DRV compilation
$(IRIDIUM_DRV_OBJDIR)/%-$(VERSION).o : $(IRIDIUM_DRV_SRCDIR)/%.c
	mkdir -p $(@D)
