...
uint32_t vectors[] __attribute__((section(".isr_vector"))) = {
    ...
    (uint32_t)&Generic_IRQHandler, // CAN1_TX_IRQHandler
    (uint32_t)&Generic_IRQHandler, // CAN1_RX0_IRQHandler
    (uint32_t)&Generic_IRQHandler, // CAN1_RX1_IRQHandler
    (uint32_t)&Generic_IRQHandler, // CAN1_SCE_IRQHandler
    ...
    (uint32_t)&Generic_IRQHandler, // FSMC_IRQHandler
    ...
    (uint32_t)&Generic_IRQHandler, // CAN2_TX_IRQHandler
    (uint32_t)&Generic_IRQHandler, // CAN2_RX0_IRQHandler
    (uint32_t)&Generic_IRQHandler, // CAN2_RX1_IRQHandler
    (uint32_t)&Generic_IRQHandler, // CAN2_SCE_IRQHandler
