...
const taskStaticConf_t g_tasks_static_conf[NB_TASKS] = 
{
    ...
    { TM_SENDER       , "TmSenderMain"    , TmSenderMain    , PRIORITY_LOW          , 1024u      , 100u           , 500u             },
    { TC_SCHEDULER    , "TcSchedulerMain" , TcSchedulerMain , PRIORITY_NORMAL       , 1024u      , 500u           , 500u             },
    { TC_PROCESS      , "TcProcessMain"   , TcProcessMain   , PRIORITY_NORMAL       , 2024u      , 500u           , 500u             },
};
