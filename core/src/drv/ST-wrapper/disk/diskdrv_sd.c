...
extern coreStatus_t SD_DiskErase(uint32_t StartAddr, uint32_t EndAddr);

/*************************** Variables Definitions ***************************/

static SD_HandleTypeDef IN_CORE_DATA_SECTION sd_card_inst; /**< SD card instance */
 ...
 * @return      DSTATUS 
 */
DSTATUS IN_CORE_TEXT_SECTION SD_DiskStatus(uint8_t disk)
{
 ...
 */
coreStatus_t IN_CORE_TEXT_SECTION SD_DiskInit(uint8_t disk)
{
 ...
 * @retval      #CORE_SUCCESSFUL else
 */
coreStatus_t IN_CORE_TEXT_SECTION SD_DiskRead(uint8_t disk, uint8_t *data, uint32_t addr, uint32_t len)
{
    // Variables Initialisation
    coreStatus_t return_value = CORE_SUCCESSFUL;
 ...
 * @retval      #CORE_SUCCESSFUL else
 */
coreStatus_t IN_CORE_TEXT_SECTION SD_DiskWrite(uint8_t disk, const uint8_t *data, uint32_t addr, uint32_t len)
{
    // Variables Initialisation
    coreStatus_t return_value = CORE_SUCCESSFUL;
 ...
 * @retval          #CORE_SUCCESSFUL else
 */
coreStatus_t IN_CORE_TEXT_SECTION SD_DiskIoctl(uint8_t disk, uint8_t cmd, void *data)
{
    // Variables Initialization
    coreStatus_t return_value = CORE_ERROR;
 ...
 * @retval      #CORE_SUCCESSFUL else
 */
coreStatus_t IN_CORE_TEXT_SECTION SD_DiskErase(uint32_t StartAddr, uint32_t EndAddr)
{
    // Variable Initialisation
    uint8_t return_value = CORE_SUCCESSFUL;
