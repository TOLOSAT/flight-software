...
static RTC_HandleTypeDef IN_CORE_DATA_SECTION rtc_inst = {0};
 ...
 * @retval      #CORE_ERROR if could not set RTC
 * @retval      #CORE_SUCCESSFUL else
 */
coreStatus_t IN_CORE_TEXT_SECTION RtcSetTime(const rtcTime_t *rtc_time)
{
    // Variable Initialisation
    coreStatus_t return_value = CORE_SUCCESSFUL;
 ...
 * @retval      #CORE_INVALID_PARAM if a pointer is NULL
 * @retval      #CORE_ERROR if could not read RTC
 * @retval      #CORE_SUCCESSFUL else
 */
coreStatus_t IN_CORE_TEXT_SECTION RtcGetTime(rtcTime_t *rtc_time)
{
    // Variable Initialisation
    coreStatus_t return_value = CORE_SUCCESSFUL;
    RTC_TimeTypeDef time = {0};
