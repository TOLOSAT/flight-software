...
static coreStatus_t EccInstanceInitProcedure(eccInst_t *ecc_inst);
static uint32_t GetMemoryOffset(eccInst_t *ecc_inst);

/*************************** Variables Definitions ***************************/

static eccInst_t IN_CORE_DATA_SECTION g_ecc_rams[NB_ECCRAM] = 
{
...
coreStatus_t IN_CORE_TEXT_SECTION InitEcc(void)
{
    ...
    while ((ecc_ram_index < NB_ECCRAM) && (return_value == CORE_SUCCESSFUL))
    {
 ...
 * @retval  #CORE_SUCCESSFUL else
 */
static coreStatus_t IN_CORE_TEXT_SECTION EccInstanceInitProcedure(eccInst_t *ecc_inst)
{
    // Variables Initialisation
    coreStatus_t return_value = CORE_SUCCESSFUL;
 ...
 */
static uint32_t IN_CORE_TEXT_SECTION GetMemoryOffset(eccInst_t *ecc_inst)
{
 ...
 */
void IN_CORE_TEXT_SECTION ECC_IRQHandler(void)
{
