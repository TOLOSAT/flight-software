...
extern coreStatus_t UartOpen(uartInst_t *uart_inst);
extern coreStatus_t UartWrite(uartInst_t *uart_inst, uartMsg_t *msg, uartMsgLength_t length);
extern coreStatus_t UartRead(uartInst_t *uart_inst, uartMsg_t *msg, uartMsgLength_t length);
extern coreStatus_t UartIoctl(uartInst_t *uart_inst, uint32_t cmd, void *data, uint32_t data_size);
extern coreStatus_t UartClose(uartInst_t *uart_inst);
