...
extern coreStatus_t SpiOpen(spiInst_t *spi_inst);
extern coreStatus_t SpiWrite(spiInst_t *spi_inst, spiMsg_t *msg, spiMsgLength_t length);
extern coreStatus_t SpiRead(spiInst_t *spi_inst, spiMsg_t *received_msg, spiMsg_t *transmit_msg, spiMsgLength_t length);
extern coreStatus_t SpiIoctl(spiInst_t *spi_inst, uint32_t cmd, void *data, uint32_t data_size);
extern coreStatus_t SpiClose(spiInst_t *spi_inst);
