...
extern coreStatus_t I2cOpen(i2cInst_t *i2c_inst);
extern coreStatus_t I2cWrite(i2cInst_t *i2c_inst, i2cSlaveAddr_t slave_addr, i2cMsg_t *msg, i2cMsgLength_t length);
extern coreStatus_t I2cRead(i2cInst_t *i2c_inst, i2cSlaveAddr_t slave_addr, i2cMsg_t *msg, i2cMsgLength_t length);
extern coreStatus_t I2cIoctl(i2cInst_t *i2c_inst, uint32_t cmd, void *data, uint32_t data_size);
extern coreStatus_t I2cClose(i2cInst_t *i2c_inst);
