...
extern coreStatus_t SpiSD_DiskInit(uint8_t disk);
extern coreStatus_t SpiSD_DiskRead(uint8_t disk, uint8_t *data, uint32_t addr, uint32_t len);
extern coreStatus_t SpiSD_DiskWrite(uint8_t disk, const uint8_t *data, uint32_t addr, uint32_t len);
