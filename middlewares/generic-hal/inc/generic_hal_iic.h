...
#define IN_IIC_TEXT_SECTION     __attribute__((section(".text_iic")))   /**< IIC functions goes in the .text_iic */
#define IN_IIC_DATA_SECTION     __attribute__((section(".data_iic")))   /**< IIC data goes in the .data_iic */
