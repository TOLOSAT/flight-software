 ...
 */
static IN_GENERIC_HAL_DATA_SECTION DUALTIM_HandleTypeDef haltick_timer = {0};
 ...
 */
HAL_StatusTypeDef IN_GENERIC_HAL_TEXT_SECTION HAL_InitTick(void)
{
 ...
 */
static void IN_GENERIC_HAL_TEXT_SECTION HalTickCallback(DUALTIM_TimerSelTypeDef sel)
{
