...
#define IN_CONF_TABLES_SECTION__attribute__((section(".conf_tables")))/**< Conf table goes to .conf_tables section */
...
"""
    ...
    def csv_to_c_static_row(row):
        ...
        return f'    {{ {task_ref}, "{name}", {function}, {priority}, {stack_size_macro}, {default_period}, {privilege}, {{{memory_regions}}}, {stack_name}, &{tcb_name} }},\n'
 ...
 */
taskStack_t IN_TASK_STACKS_SECTION {stack_name}[{formatted_ref}_STACK_SIZE/sizeof(taskStack_t)] = {{0}};
"""
            tcb_definitions += f"""
/**
 * @var     {tcb_name}
