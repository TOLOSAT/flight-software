...
"""
    ...
    for i, buffer in enumerate(buffers):
        ...
        buffer_defs += f'#define {buffer_ref}_MSG_SIZE {buffer["Msg Size"]}u /** {buffer_ref} Message Size */\n'
        buffer_defs += f'#define {buffer_ref}_MSG_NB {buffer["Msg Nb"]}u /** {buffer_ref} Message Number */\n'
