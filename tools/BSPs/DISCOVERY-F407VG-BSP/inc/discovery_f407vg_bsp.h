...
#define TAPAS_UART_PRINT_IRQ_NO                         USART3_IRQn
#define TAPAS_UART_PRINT_CLK_ENABLE()                   __HAL_RCC_USART3_CLK_ENABLE()
#define TAPAS_UART_PRINT_CLK_DISABLE()                  __HAL_RCC_USART3_CLK_DISABLE()
#define TAPAS_UART_PRINT_TX_PIN                         GPIO_PIN_8
#define TAPAS_UART_PRINT_TX_GPIO_PORT                   GPIOD
#define TAPAS_UART_PRINT_RX_PIN                         GPIO_PIN_11
