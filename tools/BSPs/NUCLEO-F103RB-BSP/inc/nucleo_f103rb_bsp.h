...
/* UART TMTC CONSTANTS */
#define UART_TMTC                               USART1
#define UART_TMTC_IRQ_HANDLER                   USART1_IRQHandler
#define UART_TMTC_IRQ_NO                        USART1_IRQn
#define UART_TMTC_CLK_ENABLE()                  __HAL_RCC_USART1_CLK_ENABLE()
#define UART_TMTC_CLK_DISABLE()                 __HAL_RCC_USART1_CLK_DISABLE()
#define UART_TMTC_TX_PIN                        GPIO_PIN_6
#define UART_TMTC_TX_GPIO_PORT                  GPIOB
#define UART_TMTC_RX_PIN                        GPIO_PIN_7
#define UART_TMTC_RX_GPIO_PORT                  GPIOB

/* UART TMTC DMA CONSTANTS */
#define UART_TMTC_DMA_RX                        hdma_usart1_rx
#define UART_TMTC_DMA_TX                        hdma_usart1_tx
#define UART_TMTC_DMA_CLK_ENABLE()              __HAL_RCC_DMA1_CLK_ENABLE()
#define UART_TMTC_DMA_DISABLE()                 __HAL_RCC_DMA1_CLK_DISABLE()
#define UART_TMTC_DMA_RX_IRQ_HANDLER            DMA1_Channel5_IRQHandler
#define UART_TMTC_DMA_RX_IRQ_NO                 DMA1_Channel5_IRQn
#define UART_TMTC_DMA_TX_IRQ_HANDLER            DMA1_Channel4_IRQHandler
#define UART_TMTC_DMA_TX_IRQ_NO                 DMA1_Channel4_IRQn
...
/* UART PL CONSTANTS */
#define UART_PL                                 USART3
#define UART_PL_IRQ_HANDLER                     USART3_IRQHandler
#define UART_PL_IRQ_NO                          USART3_IRQn
#define UART_PL_CLK_ENABLE()                    __HAL_RCC_USART3_CLK_ENABLE()
#define UART_PL_CLK_DISABLE()                   __HAL_RCC_USART3_CLK_DISABLE()
#define UART_PL_TX_PIN                          GPIO_PIN_10
#define UART_PL_TX_GPIO_PORT                    GPIOB
#define UART_PL_RX_PIN                          GPIO_PIN_11
#define UART_PL_RX_GPIO_PORT                    GPIOB
...
#define SPI_AVIONIC                             SPI2
#define SPI_AVIONIC_IRQ_HANDLER                 SPI2_IRQHandler
#define SPI_AVIONIC_IRQ_NO                      SPI2_IRQn
#define SPI_AVIONIC_SCK_PIN                     GPIO_PIN_13
#define SPI_AVIONIC_SCK_GPIO_PORT               GPIOB
#define SPI_AVIONIC_MISO_PIN                    GPIO_PIN_14
#define SPI_AVIONIC_MISO_GPIO_PORT              GPIOB
#define SPI_AVIONIC_MOSI_PIN                    GPIO_PIN_15
